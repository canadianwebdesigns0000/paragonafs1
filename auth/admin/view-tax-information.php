<?php
    ...
    $view_tax_information_query_sql = "
        SELECT 
            users.id AS user_id,
        ...
        WHERE tax_information.email = ?"; // Add a WHERE clause to filter by user's email
    $view_tax_information_result = $db->prepare($view_tax_information_query_sql);
    $view_tax_information_result->execute([$email_id]); // Pass the user's email as an array
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Client Information</h4>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xxl-9">
                            ...
                            <div class="card" id="demo">
                                <div class="row">
                                    <?php while ($row = $view_tax_information_result->fetch(PDO::FETCH_ASSOC)) { ?>
