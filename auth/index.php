    ...
    <div class="login_div">
        ...
        <div class="content">
            ...
            <form class="login-form" method="POST" autocomplete="off" onsubmit="return validateForm(event)">
                ...
                <hr>
                <p>
                    <a href="#" data-toggle="modal" data-target="#myModal">Other Online Service &nbsp; �?�</a>
                </p>
            ...
            <div class="login-footer">
                ...
                <p style="font-size:16px;margin-top:0;text-align:center;">Paragon Accounting & Financial Service Inc. © 2024</p>
            </div>
        </div>
    </div>
</div>
