                ...
                <span>
                    <?php
                        if (!isset($_SESSION['email'])) {
                            ...
                            echo '<button class="button-82-pushable" onclick="window.location.href=\'../auth/\'" role="button">
                    ...
                    <!-- <a href="../auth/" class="button-85" role="button">Sign In</a> -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 header_top_time">
                <a href="/"> <img src="../assets/img/paragon_logo.png" alt="logo" style="width: 190px; height:65px"></a>
            </div>
