...
<body>
    ...
    <section style="background-image: url(https://paragonafs.limneo.com/assets/img/upload_document_banner.jpg);background-position: center center;background-repeat: no-repeat;background-size: cover;margin-bottom: 0px;height: 422px;z-index: 0;position: relative; ">
    ...
    <div class="container row personal_upload_document">
        ...
        <div class="col-lg-8">
            ...
            <form action="/gmailapi_new.php" id="myForm" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="tab_content">
                            ...
                            <div class="tabs_item applicant_name_tab_item">
                                ...
                                <div id="rent_info mb-2">
                                    ...
                                    <div id="rent_id" class="repeater" style="margin-left: auto; margin-right: auto;">
                            ...
                            <div class="tabs_item applicant_spouse_tab_item" style="display:none">
                                ...
                                <div id="spouse_rent_info mb-2">
                                    <label class="mt-4 mb-4" style="font-size: 15px;"><b style="color: #0075be; font-size: 16px;">Rent Information</b><br>
                                        If you want to claim your benefit, please provide us below mentioned rent details.
                                    </label>

                                    <div id="spouse_rent_id" class="repeater" style="margin-left: auto; margin-right: auto;">
                                        <table border="1" style="border: none;">
                                            <thead>
                                                <tr>
                                                    <th style="width:50%">Rent Address</th>
                                            ...
                                            <tbody data-repeater-list="spouse_rent_address">
                                                <tr data-repeater-item>
                                                    <td data-label="Rent Address"><input class="form-control spouse_rent_address_search" name="spouse_rent_address"></td>
                                                    <td data-label="Total Months of Rent"><input class="form-control spouse_total_month_rent" name="spouse_total_month_rent"></td>
                                                    <td data-label="Total Rent Paid"><input class="form-control spouse_total_rent_paid" name="spouse_total_rent_paid"></td>
                                                    <td>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjVd5xnwxa--k2sVcH-d53TlXc4HF8JBI&callback=initAutocomplete&libraries=places&v=weekly" defer></script>
