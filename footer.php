...
<script src="https://paragonafs.ca/assets/bootstrap/js/bootstrap.min.js"></script>
<script src="https://paragonafs.ca/assets/js/progresscircle.js"></script>
<script src="https://paragonafs.ca/assets/js/counto.min.js"></script>
<script src="https://paragonafs.ca/assets/js/countMe.min.js"></script>
<script>
    AOS.init();
</script>
<script>
...
$(document).ready(function() {
    ...
    var newListItem = `
    	<li class="nav-item">
               <a class="nav-link" href="/new-corp.php">Business Registration</a>
        </li>
    <div>
                        <a class="btn text-uppercase hvr-bounce-to-bottom2" id="navbar_button" href="/form"" style="letter-spacing: 1px; border:none;text-align: center;background: crimson;color:white;">Personal Tax </a>
                    </div>
                        
                        <div>
                        <a class="btn text-uppercase hvr-bounce-to-bottom2" id="navbar_button" href="/corporation-tax" style="letter-spacing: 1px; border:none;text-align: center;background:black;color:white;">Corporate Tax </a>
                    </div>
                </div>
		`;

    // Append the new <li> to the <ul>
    $('#navbarsExample08XL ul.navbar-nav').append(newListItem);
}); */
</script>
