        ...
        $(document).ready(function() {
            ...
            var val = {
                ...
                messages: {
                    ...
                    rent_address: 'Rent address is required',
                    ...
                    "data[0][child_first_name]": 'Child First Name<br> is required',
                    "data[0][child_last_name]": 'Child Last Name <br>is required',
                    "data[0][child_date_birth]": 'Child Date Birth <br>is required',
                    "data[0][child_residing_canada]": 'Child Residence<br> is required',
                    "data[1][child_first_name]": 'Child First Name<br> is required',
                    "data[1][child_last_name]": 'Child Last Name <br>is required',
                    "data[1][child_date_birth]": 'Child Date Birth <br>is required',
                    "data[1][child_residing_canada]": 'Child Residence<br> is required',
                    
                    "data[2][child_first_name]": 'Child First Name is<br> required',
                    "data[2][child_last_name]": 'Child Last Name is<br> required',
                    "data[2][child_date_birth]": 'Child Date Birth is<br> required',
                    "data[2][child_residing_canada]": 'Child Residence is <br>required',
                
                    "data[3][child_first_name]": 'Child First Name is<br> required',
                    "data[3][child_last_name]": 'Child Last Name is <br>required',
                    "data[3][child_date_birth]": 'Child Date Birth is<br> required',
                    "data[3][child_residing_canada]": 'Child Residence<br> is required',
                
                    "data[4][child_first_name]": 'Child First Name is <br>required',
                    "data[4][child_last_name]": 'Child Last Name is <br>required',
                    "data[4][child_date_birth]": 'Child Date Birth is<br> required',
                    "data[4][child_residing_canada]": 'Child Residence <br>is required',
                    
                    "group-a[0][rent_address]": 'Rent address is required',
                            ...
                            <div class="repeater" id="have_child_body" style="overflow-x:auto; display:none; margin-top: 0px;">
                                ...
                                <div class="form-check form-check-inline"  style="width: 50px; margin-left: 1rem; margin-right:0px;">
                                    <input type="radio" class="form-check-input" id="child_residing_canada" name="child_residing_canada" value="Yes" required
                                        <?= ($child['child_residing_canada'] == 'Yes') ? 'checked' : '' ?>  style="width:15px">
                                    <label for="residing_canada_yes" class="form-check-label">&nbsp;Yes</label>
                                </div>

                                <div class="form-check form-check-inline"  style="width:50px; margin-left: 1rem; margin-right:0px;">
                                    <input type="radio" class="form-check-input" id="child_residing_canada" name="child_residing_canada" value="No"
                                        <?= ($child['child_residing_canada'] == 'No') ? 'checked' : ''?>  style="width:15px">
                                    <label for="residing_canada_no" class="form-check-label">&nbsp;No</label>
                                        ...
                                        ?>
                                            <tr data-repeater-item>
                                                ...
                                                <td data-label="Child Date of Birth">
                                                 ...
                                                 <td data-label="Residing in Canada">
                                                    <input type="text" class="form-control child_in_canada" name="child_residing_canada" required>
                                                </td>
                            ...
                            <div class="tabs_item applicant_name_tab_item">
                                ...
                                <div id="upload_additional_documents">
                                    ...
                                    <div class="FileUpload">
                                     ...
                                     <label class="form-label"><b> Do you want to claim your rent benefit? <span style="color: red;">*</span></b></label>
                                                                        <br>
...
<div class="form-check form-check-inline">
    <input type="radio" class="form-check-input" id="show_rent" name="rent_benefit" value="Yes" required>
    <label for="show_rent" class="form-check-label">Yes</label>
</div>

<div class="form-check form-check-inline">
    <input type="radio" class="form-check-input" id="hide_rent" name="rent_benefit" value="No" checked>
...
document.addEventListener("DOMContentLoaded", function() {
    const rentDiv = document.getElementById("rent-id");
    const rentOptions = document.getElementsByName("rent_benefit");
        ...
        option.addEventListener("change", function() {
            if (this.value === "Yes") {
                ...
                rentDiv.style.display = "none";
                                    ...
                                    <div id="rent-id" class="repeater mt-3" style="display: block;">
    ...
    <tbody data-repeater-list="group-a">
        <tr data-repeater-item>
            <td data-label="Rent Address">
                ...
                <span class="text-danger error-msg" style="display: none;">Rent Address is required.</span>
            </td>
            ...
            <td data-label="From Date">
                <div class="row">
                    ...
                    <div class="col-md-6" style="width:100px; margin-left:-20px">
                        <input class="form-control" type="text" name="from_year" id="from_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                    </div>
                </div>
            </td>
            ...
            <td data-label="To Date">
                <div class="row">
                    ...
                    <div class="col-md-6" style="width:100px; margin-left:-20px">
                        <input class="form-control" type="text" name="to_year" id="to_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                    </div>
                </div>
                <span id="to_date_error" class="text-danger" style="display:none;">To Date must be later than From Date.</span>
            </td>

            <td data-label="Total Rent Paid">
                <input class="form-control total_rent_paid  benefit_rent_address" name="total_rent_paid" required>
                <span class="text-danger error-msg" style="display: none;">Total Rent is required.</span>
            </td>
            <td>
    ...
    <div id="spouse_rent_id" class="repeater mt-3" style="margin-left: auto; margin-right: auto;">
        <table border="1" style="border: none;">
            ...
            <tbody data-repeater-list="group-a">
                <tr data-repeater-item>
                    <td data-label="Rent Address">
                        <input id="spouse_rent_address" class="form-control rent_address_search" name="rent_address" required>
                        <span class="text-danger error-msg" style="display: none;">Rent Address is required.</span>
                    </td>
                    ...
                    <td data-label="From Date">
                        <div class="row">
                            <div class="col-md-6" style="width:110px">
                                <select class="form-control" name="from_month" id="spouse_from_month" required>
                                    <option value="">Month ⏷</option>
                                    <option value="Jan">Jan</option>
                                    <option value="Feb">Feb</option>
                                    <option value="Mar">Mar</option>
                            ...
                            <div class="col-md-6" style="width:100px; margin-left:-20px">
                                <input class="form-control" type="text" name="from_year" id="spouse_from_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                            </div>
                        </div>
                    </td>
                    ...
                    <td data-label="To Date">
                        <div class="row">
                            <div class="col-md-6" style="width:110px">
                                <select class="form-control" name="to_month" id="spouse_to_month" required>
                                    <option value="">Month ⏷</option>
                                    <option value="Jan">Jan</option>
                                    <option value="Feb">Feb</option>
                                    <option value="Mar">Mar</option>
                            ...
                            <div class="col-md-6" style="width:100px; margin-left:-20px">
                                <input class="form-control" type="text" name="to_year" id="spouse_to_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                            </div>
                        </div>
                        <span id="spouse_to_date_error" class="text-danger" style="display:none;">To Date must be later than From Date.</span>
                    </td>

                    <td data-label="Total Rent Paid">
                        <input class="form-control total_rent_paid" name="total_rent_paid" required>
                        <span class="text-danger error-msg" style="display: none;">Total Rent is required.</span>
                    </td>
                    <td>
                        <span class="form-control rent_info_delete" data-repeater-delete type="button" style="text-align: center;width: 50px;">
            ...
            <div class="col-12 text-center">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="contact-box">
                            <i aria-hidden="true" class="fas fa-location-arrow" style="font-size: 40px;line-height: 40px;"></i>
                            <h6>Office Location HUUUUUUUUUU!</h6>
                            <p class="par-p mt-2">#1f9afafasffaaA - 1, Bartley Bull Pkwy, Brampton, Ontario L6W 3T7</p>
                        </div>
