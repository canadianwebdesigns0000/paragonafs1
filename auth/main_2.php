                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4 auth-one-bg h-100">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            ...
                                            <div>
                                                <!-- Headings -->
                                                <h3 class="text-warning mb-5">Welcome to Paragon Accounting</h3>
                                                
                                                <h5 class="text-light mt-5 mb-5 lh-base"><em>We are glad to have you. Please enter all details to create an account. After creating an account, an email will be sent to you to activate your account.</em></h5>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control rounded-0 border-left-only" id="first_name" placeholder="Enter First Name" required>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control rounded-0 border-left-only" id="last_name" placeholder="Enter Last Name" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control rounded-0 border-left-only" id="phone" placeholder="Enter Phone Number" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control rounded-0 border-left-only" id="confirm_email" placeholder="Enter Confirm Email" required>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="position-relative auth-pass-inputgroup">
                                                                <input type="password" class="form-control pe-5 password-input rounded-0 border-left-only" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                                <input type="password" class="form-control pe-5 password-input rounded-0 border-left-only" onpaste="return false" placeholder="Confirm password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="confirm-password-input" required>
                                                    ...
                                                    <div class="mb-4">
                                                        <p class="mb-0 fs-12 text-muted fst-italic">By creating an account, you are agreeing to our privacy policy and terms of use. You also agree to receive exclusive offers via email; you can unsubscribe at any time.</p>
                                                    </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Already have an account ? <a href="main.php" class="fw-semibold text-primary text-decoration-underline"> Sign In</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
