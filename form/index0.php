                            ...
                            <div class="tabs_item applicant_name_tab_item">
                                ...
                                <div id="upload_additional_documents">
                                    ...
                                    <div class="FileUpload">
                                     ...
                                     <label class="form-label"><b> Claim your rent benefit<span style="color: red;">*</span></b></label>
                                                                        <br>
    ...
    <tbody data-repeater-list="group-a">
        <tr data-repeater-item>
            <td data-label="Rent Address">
                <input id="rent_address" class="form-control rent_address_search" name="rent_address" required>
    ...
    <div id="spouse_rent_id" class="repeater mt-3" style="margin-left: auto; margin-right: auto;">
        <table border="1" style="border: none;">
            ...
            <tbody data-repeater-list="group-a">
                <tr data-repeater-item>
                    <td data-label="Rent Address">
                        <input id="spouse_rent_address" class="form-control rent_address_search" name="spouse_rent_address" required>
                        <span class="text-danger error-msg" style="display: none;">Rent Address is required.</span>
                    </td>
                    ...
                    <td data-label="From Date">
                        <div class="row">
                            <div class="col-md-6" style="width:110px">
                                <select class="form-control" name="spouse_from_month" id="spouse_from_month" required>
                                    <option value="">Month ⏷</option>
                                    <option value="Jan">Jan</option>
                                    <option value="Feb">Feb</option>
                                    <option value="Mar">Mar</option>
                            ...
                            <div class="col-md-6" style="width:100px; margin-left:-20px">
                                <input class="form-control" type="text" name="spouse_from_year" id="spouse_from_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                            </div>
                        </div>
                    </td>
                    ...
                    <td data-label="To Date">
                        <div class="row">
                            <div class="col-md-6" style="width:110px">
                                <select class="form-control" name="spouse_to_month" id="spouse_to_month" required>
                                    <option value="">Month ⏷</option>
                                    <option value="Jan">Jan</option>
                                    <option value="Feb">Feb</option>
                                    <option value="Mar">Mar</option>
                            ...
                            <div class="col-md-6" style="width:100px; margin-left:-20px">
                                <input class="form-control" type="text" name="spouse_to_year" id="spouse_to_year" placeholder="Year" maxlength="4" pattern="\d{4}" required>
                            </div>
                        </div>
                    ...
                    <td data-label="Total Rent Paid">
                        <input class="form-control total_rent_paid" name="spouse_total_rent_paid" required>
                        <span class="text-danger error-msg" style="display: none;">Total Rent is required.</span>
                    </td>
                    <td>
                        <span class="form-control rent_info_delete" data-repeater-delete type="button" style="text-align: center;width: 50px;">
