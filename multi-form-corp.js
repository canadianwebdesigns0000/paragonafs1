(function ($) {
	$.fn.multiStepForm = function (args) {
		...
		form.find('.submit').on('click', function (e) {
        	...
        	var business_gst_number = document.querySelector('input[name="business_gst_number"]').value;
            var upload_business_gst_number = document.getElementById("upload_business_gst_number");
            if(business_gst_number.trim() === ''){
                createAlert(
					'Please add business or GST/HST number',
					'',
					'',
					'danger',
					true,
				...
				upload_business_gst_number.scrollIntoView();
				return false;
            }

            var phone_bills = document.querySelector('input[name="phone_bills"]').value;
            var expenses_phone_bills = document.getElementById("expenses_phone_bills");
            if(phone_bills.trim() === ''){
                createAlert(
					'Please add Phone bill(Monthly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_phone_bills.scrollIntoView();
				return false;
            }

            var fuel_costs = document.querySelector('input[name="fuel_costs"]').value;
            var expenses_fuel_costs = document.getElementById("expenses_fuel_costs");
            if(fuel_costs.trim() === ''){
                createAlert(
					'Please add Fuel Cost(Monthly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_fuel_costs.scrollIntoView();
				return false;
            }

            var rent = document.querySelector('input[name="rent"]').value;
            var expenses_rent = document.getElementById("expenses_rent");
            if(rent.trim() === ''){
                createAlert(
					'Please add Rent(Monthly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_rent.scrollIntoView();
				return false;
            }

            var repairs_and_maintenance = document.querySelector('input[name="repairs_and_maintenance"]').value;
            var expenses_repairs_and_maintenance = document.getElementById("expenses_repairs_and_maintenance");
            if(repairs_and_maintenance.trim() === ''){
                createAlert(
					'Please add Repairs and Maintenance (Yearly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_repairs_and_maintenance.scrollIntoView();
				return false;
            }

            var vehicle_emi = document.querySelector('input[name="vehicle_emi"]').value;
            var expenses_vehicle_emi = document.getElementById("expenses_vehicle_emi");
            if(vehicle_emi.trim() === ''){
                createAlert(
					'Please add Vehicle emi (Monthly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_vehicle_emi.scrollIntoView();
				return false;
            }

            var car_insurance = document.querySelector('input[name="car_insurance"]').value;
            var expenses_car_insurance = document.getElementById("expenses_car_insurance");
            if(car_insurance.trim() === ''){
                createAlert(
					'Please add Car insurance (Monthly)',
					'',
					'',
					'danger',
					true,
				...
				expenses_car_insurance.scrollIntoView();
				return false;
            }
				...
				if (spouseCheckFileTax === 'No' || CheckresidingCanada === 'No' || spouseCheckFileTax === null || maritalStatusUser === "Single" || maritalStatusUser === "Separated" || maritalStatusUser === "Widow" || maritalStatusUser === "Divorced") {
					...
					if (spouseTabParentDisplayStyle !== "none") {
						...
						if (uploadIdProofCheck3.value.trim() === '') {
							...
							alert(incomeSpouseDeliveryValue);
		...
		if (document.body.scrollTop > 350 || document.documentElement.scrollTop > 350) {
			...
			if (curIndex() === 0) {
				...
				if (isVisible) {
					...
					myContinueButton.style.display = "none";
				} else {
					...
					if (buttonPosition.top <= 0) {
						...
						myContinueButton.style.display = "flex";
					}
				}
